...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if ($maintenanceReport !== null) {
        ...
        $pdf->Cell(0, 10, mb_convert_encoding('Fecha de generación: ' . date('Y-m-d H:i:s'), 'ISO-8859-1', 'UTF-8'), 0, 1);
        ...
        // Reporte de Mantenimiento (en tabla)
        $pdf->SetFont('Roboto', 'B', 14);
