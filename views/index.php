    ...
    <div id="default-carousel" class="relative w-full" data-carousel="static">
        <div class="relative h-56 overflow-hidden md:h-96">
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="assets/imagen1.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 object-fill" alt="...">
                <div class="absolute inset-0 bg-black opacity-50 flex items-center justify-center text-white object-none">
                    <img src="assets/logo.png" class="opacity-100 object-none" alt="...">
                </div>
            </div>
            <!-- Item 2 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="assets/imagen2.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 object-fil" alt="...">
                <div class="absolute inset-0 bg-black opacity-50 flex items-center justify-center text-white object-none">
            ...
            <!-- Item 3 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="assets/imagen3.webp" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 object-fil" alt="...">
                <div class="absolute inset-0 bg-black opacity-50 flex items-center justify-center text-white object-none">
            ...
            <!-- Item 4 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="assets/imagen4.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 object-fil" alt="...">
                <div class="absolute inset-0 bg-black opacity-50 flex items-center justify-center text-white object-none">
            ...
            <!-- Item 5 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="assets/imagen5.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 object-fil" alt="...">
                <div class="absolute inset-0 bg-black opacity-50 flex items-center justify-center text-white object-none">
